...
class TestWebAlumnoPortal(unittest.TestCase):
    ...
    def test_rutas_no_contienen_alumno_id(self):
        ...
        self.assertEqual(sorted(rules), sorted(["/alumno", "/alumno/credencial", "/alumno/credencial/generar", "/alumno/credencial/renovar", "/alumno/historial", "/alumno/historial/movimientos/<int:movimiento_id>"]))
